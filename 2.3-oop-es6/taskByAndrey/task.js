...
class PhoneBook {
    ...
    validation(name){return this.phoneBook.map((elem)=>elem.name).includes(name)}
    addContact(name, phone) {
...
log.editUser('Alexey', '+79052430565', 'Alex-Dentist') // Меняет имя
log.editUser('John', 'Paul') // Контакт не найден
